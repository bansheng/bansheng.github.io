...
{{< mermaid >}}
graph LR
    A[“Stage1: 用户行为序列”] --> B(“Stage1: Transformer Decoder”)
    B --> C[“Stage1: 预测下一Item”]
    C --> D{“Stage1: 预训练模型”}

    E[“Stage2: 稀疏参数 Embeddings”]
    F[“Stage2: 稠密参数 Transformer”]

    H[“Stage3: 上下文+候选物品”] --> G(“Stage3: 判别式Transformer”)
    G --> I[“Stage3: 预估CTR/CVR”]
